...
public class PizzaOrder
    {
        public static void main (String[] args)
        {
            ...
            if (firstName.equalsIgnoreCase("Diane") || firstName.equalsIgnoreCase("Mike")) {
                discount = true;
                System.out.println("Congrats! Youw will get discount");
            }
            ...
            if (inches == 10){
                cost=10.99;
                System.out.println("You have chosen 10 inch pizza and it costs is $10.99");
            } else if (inches == 12) {
                cost=12.99;
                System.out.println("You have chosen 12 inch pizza and it costs is $12.99");
            } else if (inches == 14) {
                cost=14.99;
                System.out.println("You have chosen 14 inch pizza and it costs is $14.99");
            } else if (inches == 16){
                cost=16.99;
                System.out.println("You have chosen 16 inch pizza and it costs is $16.99");
            } else {
                System.out.println("The user input was not one of the choices");
            }
            ...
            switch (crustType){
                case 'H': case 'h':
                    crust = "Hand-tossed";
                    System.out.println("\n You have chosen Hand-tossed");
                    break;

                case 'T': case 't':
                    crust = "Thin-crust";
                    System.out.println("\n You have chosen Thin-crust");

                case 'D': case 'd':
                    crust = "Deep-dish";
                    System.out.println("\n You have chosen Deep-dish");
            ...
            {
                cost -= 2.00;
                System.out.println(" \n You are eligible for a 2$ discount \n ");
            }
